...
Rails.application.configure do
  ...
  config.logger = ActiveSupport::Logger.new("log/production.log", 1, 256.megabytes)
  ...
  # config.active_job.queue_name_prefix = "pcoe_de_equipment_production"
